...
func Strength(v int) predicate.Drug {
	return predicate.Drug(func(s *sql.Selector) {
...
func StrengthEQ(v int) predicate.Drug {
	return predicate.Drug(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldStrength), v))
	})
}
...
func StrengthNEQ(v int) predicate.Drug {
	return predicate.Drug(func(s *sql.Selector) {
...
func StrengthIn(vs ...int) predicate.Drug {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func StrengthNotIn(vs ...int) predicate.Drug {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func StrengthGT(v int) predicate.Drug {
	return predicate.Drug(func(s *sql.Selector) {
...
func StrengthGTE(v int) predicate.Drug {
	return predicate.Drug(func(s *sql.Selector) {
...
func StrengthLT(v int) predicate.Drug {
	return predicate.Drug(func(s *sql.Selector) {
...
func StrengthLTE(v int) predicate.Drug {
	return predicate.Drug(func(s *sql.Selector) {
...
func HasUserWith(preds ...predicate.User) predicate.Drug {
	return predicate.Drug(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
