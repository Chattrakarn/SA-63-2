...
func (e DrugEdges) UserOrErr() (*User, error) {
	if e.loadedTypes[0] {
		if e.User == nil {
...
// QueryUser queries the user edge of the Drug.
...
func (d *Drug) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", d.Strength))
